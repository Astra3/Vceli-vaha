...
class HX711Update(HX711):
    def __init__(self, dout_pin, pd_sck_pin, scale=1):
        super().__init__(dout_pin, pd_sck_pin)
        self.zero()
        self.set_scale_ratio(scale)

    @property
    def weight(self):
        return self.get_weight_mean(20)

    @property
    def reference(self):
        return self.get_current_scale_ratio()
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        GPIO.cleanup()
        logging.debug("proběhl GPIO cleanup")
        pass
